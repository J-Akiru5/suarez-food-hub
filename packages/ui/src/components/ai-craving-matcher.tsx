...
const AICravingMatcher = React.forwardRef<HTMLDivElement, AICravingMatcherProps>(
  ({ onFilter, className }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "fixed bottom-10 left-10 z-[999] flex flex-col items-start gap-3",
          className
        )}
      >
        {/* Expanded Card */}
