    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 bg-gradient-to-b from-brand-50 to-white">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-brand-600">SFH Staff</h1>
            <p className="text-xs text-muted-foreground">Kitchen Operations</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl shadow-lg p-6 border border-brand-100">
          <h2 className="text-xl font-bold mb-1">Welcome back</h2>
          <p className="text-sm text-muted-foreground mb-6">Sign in to your staff account</p>
