...
export default function AboutPage() {
  return (
    <div className="min-h-screen" style={{ background: "var(--color-cream)" }}>
      ...
      {/* Hero */}
      <section className="pt-[74px] py-16 sm:py-24" style={{ background: "linear-gradient(to bottom right, color-mix(in srgb, var(--primary-color) 8%, white), var(--color-cream))" }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-4xl font-bold sm:text-5xl" style={{ color: "var(--secondary-color)", fontFamily: "var(--playfair-display)" }}>
              About Suarez Food Hub
            </h1>
            <p className="mt-6 text-lg" style={{ color: "color-mix(in srgb, var(--secondary-color) 60%, transparent)" }}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="glass-card p-8">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl" style={{ background: "color-mix(in srgb, var(--primary-color) 10%, transparent)", color: "var(--primary-color)" }}>
      ...
      <section className="py-16 sm:py-20" style={{ background: "color-mix(in srgb, var(--primary-color) 3%, white)" }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold" style={{ color: "var(--secondary-color)", fontFamily: "var(--playfair-display)" }}>Our Values</h2>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value) => (
              <div key={value.title} className="glass-card p-6 text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: "color-mix(in srgb, var(--primary-color) 10%, transparent)", color: "var(--primary-color)" }}>
                  <value.icon className="h-6 w-6" />
                </div>
                <h3 className="mt-4 text-base font-semibold" style={{ color: "var(--secondary-color)" }}>
                  {value.title}
                </h3>
                <p className="mt-2 text-sm" style={{ color: "color-mix(in srgb, var(--secondary-color) 50%, transparent)" }}>
                  {value.description}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold" style={{ color: "var(--secondary-color)", fontFamily: "var(--playfair-display)" }}>Our Journey</h2>
            <p className="mt-3" style={{ color: "color-mix(in srgb, var(--secondary-color) 50%, transparent)" }}>
              From a home kitchen to your neighborhood food hub
            </p>
          </div>
          <div className="relative mt-12">
            <div className="absolute left-4 top-0 h-full w-0.5 sm:left-1/2 sm:-translate-x-px" style={{ background: "color-mix(in srgb, var(--primary-color) 30%, transparent)" }} />
            <div className="space-y-8">
              {timeline.map((item, index) => (
                ...
                >
                  <div className="absolute left-4 top-1 h-4 w-4 -translate-x-1/2 rounded-full border-2 bg-white sm:left-1/2" style={{ borderColor: "var(--primary-color)" }} />
                  <div
                    className={`ml-10 flex-1 sm:ml-0 ${
                      index % 2 === 0 ? "sm:text-right sm:pr-12" : "sm:text-left sm:pl-12"
                    }`}
                  >
                    <span className="inline-block rounded-full px-3 py-1 text-sm font-semibold" style={{ background: "color-mix(in srgb, var(--primary-color) 10%, transparent)", color: "var(--primary-color)" }}>
                      {item.year}
                    </span>
      ...
      {/* CTA */}
      <section className="py-16" style={{ borderTop: "1px solid color-mix(in srgb, var(--primary-color) 10%, transparent)", background: "color-mix(in srgb, var(--primary-color) 5%, white)" }}>
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold" style={{ color: "var(--secondary-color)", fontFamily: "var(--playfair-display)" }}>
