  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <ul
            style={{ listStyle: "none", padding: "24px", margin: 0, display: "flex", flexDirection: "column", gap: 24 }}
          >
            <li>
              <Link
                href="/"
                style={{ color: "var(--secondary-color)", textDecoration: "none", fontSize: 18, fontWeight: 700 }}
